  ...
  <body>
    ...
    <div class="container mt-5">
        <h3 style="color: #800080" class="text-center">
            SANYU BABIES HOME DONATION REPORT FOR YEAR ENDING {{ date('Y')}} <small><a href="javascript:;" onclick="printReport(this)">Print Report</a></small>
        </h3>
        ...
        <div class="d-flex justify-content-end">
            <span>Generated on {{  date("D d M Y", strtotime(date('Y-m-d')))}}</span>
        </div>
    </div>
