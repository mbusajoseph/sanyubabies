	...
	<div class="row justify-content-center">
		<div class="col-lg-12">
			<div class="card card-body shadow">
				<div class="row">
					<div class="col-lg-4">
						<img src="{{ asset('imgs/site/others.jpg') }}" class="img" width="100%"/>
					...
					<div class="col-lg-8">
						...
						<form action="{{ url('donations/save') }}" method="POST" id="othersForm">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="fname" class="w-100"> First Name 
                                            ...
                                            autocomplete="off" value="{{ $user->last_name !== '' ? $user->first_name : '' }}" required/>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-6">
