	...
	<div class="row justify-content-center">
		<div class="col-lg-12">
			<div class="card card-body shadow">
				<div class="row">
					<div class="col-lg-4">
						<img src="<?php echo e(asset('imgs/site/Food-charity.jpg')); ?>" class="img" width="100%"/>
						<h3>Sanyu Babies Home <i class="fas fa-check-circle text-success"></i> </h3>
						<h5 class="text-muted">
							Hello, welcome to Sanyu Babies Home. Please fill in the required details in the form provided in order to continue and donate Food to children at <span class="text-success">Sanyu Babies Home <i class="fas fa-heart text-danger"></i> </span>
						</h5>
					</div>
						...
						<form action="<?php echo e(url('donations/save')); ?>" method="POST" id="foodForm">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <ul class="unstyled">
                                        <li>
                                            <a href="javascrpt:void(0)" class="btn btn-success btn-sm" id="other-foods-btn">Other Foods <i class="fas fa-plus-circle"></i> </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sanyubabies\app\views/donations/food.blade.php ENDPATH**/ ?>