                                ...
                                <div class="row">
                                    <div class="col-lg-6 mt-3">
                                        <div class="card card-body shadow h-100 zoom">
                                            <img src="<?php echo e(asset('imgs/site/food-charity.jpg')); ?>" class="card-img img-responsive"/>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <div class="card card-body shadow h-100 zoom">
                                            <img src="<?php echo e(asset('imgs/site/clothes.jpeg')); ?>" class="card-img img-responsive"/>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <div class="card card-body shadow h-100 zoom">
                                            <img src="<?php echo e(asset('imgs/site/shoes.jpeg')); ?>" class="card-img img-responsive"/>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <div class="card card-body shadow h-100 zoom">
                                            <img src="<?php echo e(asset('imgs/site/money.jpg')); ?>" class="card-img img-responsive"/>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sanyubabies\app\views/index.blade.php ENDPATH**/ ?>