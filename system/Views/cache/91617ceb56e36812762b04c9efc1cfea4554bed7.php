	...
	<div class="row justify-content-center">
		<div class="col-lg-8">
			<div class="card card-body shadow">
				<div class="row">
					<div class="col-lg-6">
						<img src="<?php echo e(asset('imgs/site/money.jpg')); ?>" class="img" width="100%"/>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sanyubabies\app\views/donations/money.blade.php ENDPATH**/ ?>