        ...
        <div class="d-flex justify-content-between ml-4">
            ...
            <div class="mb-3">
                <ul class="unstyled">
                    ...
                    <li>
                        <a href="<?php echo e(url('donations/items/funds')); ?>" class="text-doco-none text-light"><i class="fas fa-shillings-sign"></i> Funds in Shillings</a>
                    </li>
                </ul>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\sanyu\app\views/base.blade.php ENDPATH**/ ?>